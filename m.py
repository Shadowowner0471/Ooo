...
TOKEN = '7379149406:AAFQF9Xx9QrH8VMbrF59HA7MDp_AhL80DWQ'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002259490680
CHANNEL_ID = -1002259490680
error_channel_id = -1002259490680
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@SHARP_X_OWNER*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :- @SHARP_X_OWNER*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("SHARP SERVER RUNNING.....")
    while True:
        try:
